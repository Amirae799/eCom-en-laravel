...
@section('Content')
    ...
    <div class="container">
        <div class="form-login"
             style="alignment: center;color: white;background-color: #1c7430;position: center;
              padding:10px;margin:100px;;margin-left: 300px;height: 420px;width: 450px;text-align: center">
            <h4 >admin login</h4>
